...
public class LAItems {
    ...
    public static final RegistryObject<Item> RUBY_AXE = ITEMS.register("ruby_axe",
            () -> new AxeItem(LATiers.RUBY, 5, -3.1f,
                    new Item.Properties().tab(LACreativeModeTab.LITTLE_ADDITIONS)));
    ...
    public static final RegistryObject<Item> EMERALD_AXE = ITEMS.register("emerald_axe",
            () -> new AxeItem(LATiers.EMERALD, 4, -3.1f,
                    new Item.Properties().tab(LACreativeModeTab.LITTLE_ADDITIONS)));
    ...
    public static final RegistryObject<ForgeSpawnEggItem> PIGMAN_SPAWN_EGG = ITEMS.register("pigman_spawn_egg",
            () -> new ForgeSpawnEggItem(LAEntities.PIGMAN,11956611, 0x4a4e4f,
                    new Item.Properties().tab(LACreativeModeTab.LITTLE_ADDITIONS)));

    public static final RegistryObject<ForgeSpawnEggItem> ENDER_TRADER_SPAWN_EGG = ITEMS.register("ender_trader_spawn_egg",
            () -> new ForgeSpawnEggItem(LAEntities.ENDER_TRADER,11956611, 0x4a5e6f,
                    new Item.Properties().tab(LACreativeModeTab.LITTLE_ADDITIONS)));

    public static final RegistryObject<ForgeSpawnEggItem> ZOMBIE_PIGMAN_SPAWN_EGG = ITEMS.register("zombie_pigman_spawn_egg",
            () -> new ForgeSpawnEggItem(LAEntities.ZOMBIE_PIGMAN,11957621, 279846,
                    new Item.Properties().tab(LACreativeModeTab.LITTLE_ADDITIONS)));

    public static final RegistryObject<ForgeSpawnEggItem> HUMAN_SPAWN_EGG = ITEMS.register("human_spawn_egg",
            () -> new ForgeSpawnEggItem(LAEntities.HUMAN, 0xb5bebf, 0x5a4e4f,
                    new Item.Properties().tab(LACreativeModeTab.LITTLE_ADDITIONS)));
