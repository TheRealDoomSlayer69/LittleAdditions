...
public class HumanModel<Type extends HumanEntity> extends HumanoidModel<Type> {

    public static final ModelLayerLocation LAYER_LOCATION =
            new ModelLayerLocation(new ResourceLocation(LittleAdditions.MOD_ID,"human"),"main");
    ...
    public void prepareMobModel(Type p_103793_, float p_103794_, float p_103795_, float p_103796_) {
        ...
        if (itemstack.is(Items.DIAMOND_SWORD) && p_103793_.isAggressive()) {
            if (p_103793_.getMainArm() == HumanoidArm.RIGHT) {
                ...
                if (itemstack.is(Items.SHIELD) && p_103793_.isBlocking()) {
                    if (p_103793_.getMainArm() == HumanoidArm.LEFT) {
