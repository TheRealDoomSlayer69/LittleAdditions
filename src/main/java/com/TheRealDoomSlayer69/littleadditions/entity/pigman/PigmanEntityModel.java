package com.TheRealDoomSlayer69.littleadditions.entity.pigman;// Made with Blockbench 4.4.1
...
public class PigmanEntityModel<Type extends PigmanEntity> extends HumanoidModel<Type> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION =
			new ModelLayerLocation(new ResourceLocation(LittleAdditions.MOD_ID, "pigman"), "main");

	public PigmanEntityModel(ModelPart modelPart) {
		super(modelPart);
	...
	public void prepareMobModel(Type p_103793_, float p_103794_, float p_103795_, float p_103796_) {
		...
		if (itemstack.is(LAItems.RUBY_SWORD.get()) && p_103793_.isAggressive()) {
		...
		public void setupAnim (Type p_103798_,float p_103799_, float p_103800_, float p_103801_, float p_103802_,
		float p_103803_){
			super.setupAnim(p_103798_, p_103799_, p_103800_, p_103801_, p_103802_, p_103803_);
			ItemStack itemstack = p_103798_.getMainHandItem();
			if (p_103798_.isAggressive() && (itemstack.isEmpty() || !itemstack.is(LAItems.RUBY_SWORD.get()))) {
